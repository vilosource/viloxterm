...
def mock_icon_manager():
    ...
    with (
        patch("viloapp.ui.activity_bar.get_icon_manager") as mock_activity_bar,
        patch("viloapp.ui.main_window.get_icon_manager") as mock_main_window,
    ):
...
def simulate_key_sequence(qtbot, widget, key_sequence):
    ...
    from viloapp.ui.qt_compat import safe_key_sequence_to_key
