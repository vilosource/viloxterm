...
class TestThemeEditorGUI:
    ...
    @patch("viloapp.services.service_locator.ServiceLocator.get_instance")
    ...
    @patch("viloapp.services.service_locator.ServiceLocator")
...
class TestColorPickerGUI:
    ...
    def test_color_picker_display(self, qtbot):
        ...
        from viloapp.ui.widgets.color_picker_widget import ColorPickerWidget
    ...
    def test_color_picker_field(self, qtbot):
        ...
        from viloapp.ui.widgets.color_picker_widget import ColorPickerField
...
class TestThemeEditorCommands:
    ...
    @patch("viloapp.services.service_locator.ServiceLocator.get_instance")
    @patch("viloapp.core.themes.importers.VSCodeThemeImporter.import_from_file")
    @patch("PySide6.QtWidgets.QMessageBox.information")
