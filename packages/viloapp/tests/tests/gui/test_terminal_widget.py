...
from viloapp.ui.terminal.terminal_config import (
    VSCODE_DARK_THEME,
    TerminalConfig,
)
from viloapp.ui.terminal.terminal_widget import TerminalWebPage, TerminalWidget
...
class TestTerminalWebPage:
    ...
    def test_terminal_web_page_logs_javascript_error_messages(self, qtbot):
        ...
        with patch("viloapp.ui.terminal.terminal_widget.logger") as mock_logger:
...
class TestTerminalWidget:
    ...
    def setup_mocks(self):
        ...
        with patch(
            "viloapp.ui.terminal.terminal_widget.terminal_server", self.mock_terminal_server
        ):
            with patch("viloapp.ui.terminal.terminal_widget.terminal_config", self.mock_config):
                yield
    ...
    def test_terminal_widget_error_handling_during_session_creation(self, qtbot):
        ...
        with patch("viloapp.ui.terminal.terminal_widget.terminal_server") as mock_server:
            with patch("viloapp.ui.terminal.terminal_widget.terminal_config") as mock_config:
                # Setup mocks
    ...
    def test_terminal_widget_web_view_creation_failure_raises_exception(self, qtbot):
        ...
        with patch("viloapp.ui.terminal.terminal_widget.terminal_server") as mock_server:
            with patch("viloapp.ui.terminal.terminal_widget.terminal_config") as mock_config:
                ...
                with patch(
                    "viloapp.ui.terminal.terminal_widget.QWebEngineView",
