...
class TestSettingsWidgetIntegration:
    ...
    @patch("viloapp.ui.widgets.settings_app_widget.get_app_default")
    ...
    @patch("viloapp.ui.widgets.settings_app_widget.set_app_default")
...
class TestSettingsWidgetAdvanced:
    ...
    @patch("viloapp.ui.widgets.settings_app_widget.QFileDialog.getSaveFileName")
    @patch("builtins.open", create=True)
    @patch("json.dump")
    def test_export_settings(
        self, mock_json_dump, mock_open, mock_file_dialog, settings_widget, qtbot
    ):
        ...
        # Mock export data
        with patch.object(
            settings_widget._defaults_manager,
            "export_settings",
    ...
    @patch("viloapp.ui.widgets.settings_app_widget.QFileDialog.getOpenFileName")
    @patch("builtins.open", create=True)
    @patch("json.load")
    def test_import_settings(
        self, mock_json_load, mock_open, mock_file_dialog, settings_widget, qtbot
    ):
...
class TestSettingsWidgetValidation:
    ...
    def test_invalid_setting_rejection(self, settings_widget):
        ...
        with patch("viloapp.ui.widgets.settings_app_widget.set_app_default") as mock_set:
