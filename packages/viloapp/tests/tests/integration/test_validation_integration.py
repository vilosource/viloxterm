...
from viloapp.core.commands.validation import OneOf, ParameterSpec, Range, String, validate
...
class TestValidationIntegration:
    ...
    def test_workspace_command_validation_example(self):
        ...
        from viloapp.core.commands.builtin.workspace_commands import select_tab_command
