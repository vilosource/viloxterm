    ...
    for file_path in ui_files:
        try:
            ...
            for line_num, line in enumerate(lines, 1):
                ...
                # Check for ServiceLocator imports
                if (
                    "from viloapp.services.service_locator import ServiceLocator" in line
                    or "from services import ServiceLocator" in line
                    or "import viloapp.services.service_locator" in line
                ):
    ...
    for file_path in ui_files:
        try:
            ...
            for line_num, line in enumerate(lines, 1):
                ...
                if (
                    "ServiceLocator.get_instance()" in line
                    or "ServiceLocator.get(" in line
                    or "ServiceLocator.register(" in line
                    or ".get_service(" in line
                ):  # Common service access pattern
    ...
    for file_path in ui_files:
        try:
            ...
            for line_num, line in enumerate(lines, 1):
                ...
                if (
                    "from viloapp.services." in line
                    and "service_locator" not in line
                    and "from services import" not in line
                ):
