...
from viloapp.ui.widgets.pane_header import PaneHeaderBar
from viloapp.ui.widgets.split_pane_controller import SplitPaneController
from viloapp.ui.widgets.split_pane_drag_handler import get_drag_handler
from viloapp.ui.widgets.split_pane_model import LeafNode, SplitNode, SplitPaneModel
from viloapp.ui.widgets.split_pane_theme_manager import get_theme_manager
from viloapp.ui.widgets.split_pane_view_helpers import get_view_helpers
from viloapp.ui.widgets.widget_pool import get_widget_pool
...
class SplitPaneWidget(QWidget):
    ...
    def on_terminal_close_requested(self, pane_id: str):
        ...
        from viloapp.ui.widgets.split_pane_model import LeafNode
