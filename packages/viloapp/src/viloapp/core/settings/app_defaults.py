...
HARD_CODED_FALLBACKS = {
    ...
    "viloapp.ui.default_window_width": 1200,
    "viloapp.ui.default_window_height": 800,
    "viloapp.ui.window_position": "center",
    "viloapp.ui.start_maximized": False,
    "viloapp.ui.start_fullscreen": False,
    "viloapp.ui.sidebar_visible_on_start": True,
    "viloapp.ui.default_sidebar_width": 300,
    "viloapp.ui.show_status_bar": True,
...
class AppDefaultsValidator:
    ...
    def validate_and_sanitize(key: str, value: Any) -> tuple[bool, Any]:
        ...
        validators = {
            ...
            "viloapp.ui.default_window_height": lambda v: AppDefaultsValidator.validate_positive_int(
                v, 2000, 800
            ),
            "viloapp.ui.sidebar_visible_on_start": lambda v: AppDefaultsValidator.validate_bool(
                v, True
            ),
            "viloapp.ui.default_sidebar_width": lambda v: AppDefaultsValidator.validate_positive_int(
                v, 800, 300
            ),
...
class AppDefaults:
    ...
    def migrate_legacy_settings(self) -> int:
        ...
        migration_map = {
            # UI settings
            "UI/ShowSidebar": "viloapp.ui.sidebar_visible_on_start",
            "UI/ShowActivityBar": "viloapp.ui.show_activity_bar",
            "UI/SidebarWidth": "viloapp.ui.default_sidebar_width",
            "UI/ShowStatusBar": "viloapp.ui.show_status_bar",
            "UI/ShowMenuBar": "viloapp.ui.show_menu_bar",
            "UI/FramelessMode": "viloapp.ui.frameless_mode",
            # Theme settings
...
def get_startup_window_state() -> dict[str, Any]:
    ...
    return {
        "width": get_app_default("viloapp.ui.default_window_width", 1200),
        "height": get_app_default("viloapp.ui.default_window_height", 800),
        "maximized": get_app_default("viloapp.ui.start_maximized", False),
        "fullscreen": get_app_default("viloapp.ui.start_fullscreen", False),
        "position": get_app_default("viloapp.ui.window_position", "center"),
    }
