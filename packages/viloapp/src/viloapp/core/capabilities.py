...
def get_capability_category(capability: WidgetCapability) -> CapabilityCategory:
    ...
    elif capability_name.startswith("SHELL_") or capability_name.startswith("COMMAND_") or capability_name.startswith("PROCESS_"):
        return CapabilityCategory.SHELL
    elif capability_name in ["CLEAR_DISPLAY", "SCROLL_CONTENT", "ZOOM_CONTENT", "SYNTAX_HIGHLIGHTING"]:
    ...
    elif capability_name in ["SETTINGS_MANAGEMENT", "CONFIGURATION_EDITING", "PREFERENCES_HANDLING"]:
