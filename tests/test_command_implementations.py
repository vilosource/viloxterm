...
from PySide6.QtWidgets import QApplication, QTabWidget, QInputDialog
...
class TestPaneCommands:
    ...
    def test_maximize_pane_command(self):
        ...
        initial_states = {pane: pane.isVisible() for pane in panes}
        ...
        for pane in panes[1:]:
            assert not pane.isVisible(), f"Non-maximized pane should be hidden"
...
class TestTabCommands:
    ...
    def test_rename_tab_command(self):
        ...
        original_name = self.workspace.tab_widget.tabText(0)
