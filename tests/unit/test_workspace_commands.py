...
class TestNewTabCommand:
    ...
    def test_new_tab_uses_default_widget_type(self, mock_get_default, context,
                                             workspace_service):
    ...
    def test_new_tab_with_explicit_widget_type(self, context, workspace_service,
                                               terminal_service):
    ...
    def test_new_tab_starts_terminal_server(self, context, workspace_service,
                                           terminal_service):
