...
def test_resource_type_enum():
    ...
    from core.plugin_system.security import ResourceType
...
def test_resource_monitor_creation():
    ...
    from core.plugin_system.security import ResourceMonitor
...
def test_resource_monitor_memory_tracking():
    ...
    from core.plugin_system.security import ResourceMonitor, ResourceType
...
def test_resource_limiter_creation():
    ...
    from core.plugin_system.security import ResourceLimiter, ResourceType
...
def test_resource_violation_object():
    ...
    from core.plugin_system.security import ResourceViolation, ResourceType
...
def test_resource_monitor_with_limiter_integration():
    ...
    from core.plugin_system.security import ResourceMonitor, ResourceLimiter, ResourceType
