...
def test_plugin_sandbox_creation():
    ...
    from core.plugin_system.security import PluginSandbox
...
def test_plugin_sandbox_with_permissions():
    ...
    from core.plugin_system.security import PluginSandbox, PermissionManager
...
def test_plugin_sandbox_with_resource_limiter():
    ...
    from core.plugin_system.security import (
        PluginSandbox, ResourceLimiter, ResourceType
    )
...
def test_plugin_sandbox_restart_policy():
    ...
    from core.plugin_system.security import PluginSandbox, RestartPolicy
...
def test_plugin_sandbox_integration():
    ...
    from core.plugin_system.security import (
        PluginSandbox, PermissionManager, ResourceLimiter, ResourceType,
        Permission, PermissionCategory, PermissionScope
    )
    ...
    assert sandbox.has_permission(PermissionCategory.FILESYSTEM, PermissionScope.READ, "/tmp/test.txt")
    assert not sandbox.has_permission(PermissionCategory.FILESYSTEM, PermissionScope.WRITE, "/tmp/test.txt")
...
def test_restart_policy_enum():
    ...
    from core.plugin_system.security import RestartPolicy
