...
class TestCodeChangesExist:
    ...
    def test_terminal_app_widget_has_session_handler(self):
        ...
        assert callable(getattr(TerminalAppWidget, 'on_session_ended'))
    ...
    def test_split_pane_model_has_callback_system(self):
        ...
        assert callable(getattr(model_module.SplitPaneModel, 'set_terminal_close_callback'))
        assert callable(getattr(model_module.SplitPaneModel, 'on_terminal_close_requested'))
    ...
    def test_split_pane_widget_has_terminal_handler(self):
        ...
        assert callable(getattr(widget_module.SplitPaneWidget, 'on_terminal_close_requested'))
    ...
    def test_split_pane_widget_has_close_pane_method(self):
        ...
        assert callable(getattr(widget_module.SplitPaneWidget, 'close_pane'))
