...
class TestArchitectureCompliance:
    ...
    def test_forbidden_imports_in_commands(self, command_files):
        ...
        allowed_ui_imports = [
            'from ui.widgets.widget_registry import WidgetType',  # Allowed for type references
        ]
    ...
    def test_service_error_handling_patterns(self):
        ...
        try:
            from core.commands.builtin.tab_commands import duplicate_tab_command
        ...
        try:
            from core.commands.builtin.file_commands import save_state_command
...
class TestSpecificArchitecturePatterns:
    ...
    def test_service_unavailable_error_handling(self):
        ...
        try:
            from core.commands.builtin.tab_commands import duplicate_tab_command
            from core.commands.builtin.terminal_commands import clear_terminal_handler
            from core.commands.builtin.file_commands import save_state_command
