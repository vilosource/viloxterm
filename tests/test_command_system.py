...
from core import (
    ...
    command_registry, command_executor, command,
    context_manager, ContextKey, WhenClauseEvaluator
)
...
class TestContextSystem:
    ...
    def test_context_set_get(self):
        ...
        assert context_manager.get(ContextKey.EDITOR_FOCUS) == True
    ...
    def test_context_update(self):
        ...
        assert context_manager.get(ContextKey.EDITOR_FOCUS) == True
        assert context_manager.get(ContextKey.TERMINAL_FOCUS) == False
        assert context_manager.get(ContextKey.SIDEBAR_VISIBLE) == True
...
class TestWhenClauseEvaluation:
    ...
    def test_simple_identifier(self):
        ...
        assert WhenClauseEvaluator.evaluate("editorFocus", context) == True
        assert WhenClauseEvaluator.evaluate("terminalFocus", context) == False
    
    def test_negation(self):
        """Test NOT operator."""
        context = {"editorFocus": True, "terminalFocus": False}
        
        assert WhenClauseEvaluator.evaluate("!editorFocus", context) == False
        assert WhenClauseEvaluator.evaluate("!terminalFocus", context) == True
    ...
    def test_logical_operators(self):
        ...
        # AND
        assert WhenClauseEvaluator.evaluate("editorFocus && hasSelection", context) == True
        assert WhenClauseEvaluator.evaluate("editorFocus && terminalFocus", context) == False
        
        # OR
        assert WhenClauseEvaluator.evaluate("editorFocus || terminalFocus", context) == True
        assert WhenClauseEvaluator.evaluate("terminalFocus || hasSelection", context) == True
    ...
    def test_comparisons(self):
        ...
        assert WhenClauseEvaluator.evaluate("paneCount == 3", context) == True
        assert WhenClauseEvaluator.evaluate("paneCount != 2", context) == True
        assert WhenClauseEvaluator.evaluate("paneCount > 2", context) == True
        assert WhenClauseEvaluator.evaluate("paneCount >= 3", context) == True
        assert WhenClauseEvaluator.evaluate("paneCount < 4", context) == True
        assert WhenClauseEvaluator.evaluate("paneCount <= 3", context) == True
        
        assert WhenClauseEvaluator.evaluate("platform == 'linux'", context) == True
        assert WhenClauseEvaluator.evaluate("platform != 'windows'", context) == True
