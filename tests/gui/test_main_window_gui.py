...
from tests.gui.base import MainWindowGUITestBase, KeyboardGUITestBase, ThemeGUITestBase
...
class TestMainWindowIntegrationGUI(MainWindowGUITestBase):
    ...
    def test_activity_bar_sidebar_integration(self, gui_main_window, qtbot):
        ...
        initial_view = sidebar.current_view if hasattr(sidebar, 'current_view') else 'explorer'
