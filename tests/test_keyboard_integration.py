...
from core.commands.decorators import command, register_pending_shortcuts
...
class TestKeyboardCommandIntegration:
    ...
    def test_shortcut_conflict_handling(self):
        ...
        conflicts = self.keyboard_service.get_shortcut_conflicts()
        from core.keyboard.parser import KeySequenceParser
        sequence = KeySequenceParser.parse("ctrl+x")
